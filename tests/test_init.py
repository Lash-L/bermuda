...
async def test_setup_unload_and_reload_entry(hass: HomeAssistant, bypass_get_data: None) -> None:
...
async def test_setup_entry_exception(hass: HomeAssistant, error_on_get_data: None) -> None:
