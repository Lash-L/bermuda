...
async def test_successful_config_flow(hass: HomeAssistant, bypass_get_data: None) -> None:
...
async def test_failed_config_flow(hass: HomeAssistant, error_on_get_data: None) -> None:
